...
#ifdef BUILD_MODBUSOVER_STATIC
#define MODBUSOVER_EXPORT
#else
#ifdef _MSC_VER
#ifdef MODBUSOVER_LIB
#define MODBUSOVER_EXPORT __declspec(dllexport)
#else
#define MODBUSOVER_EXPORT __declspec(dllimport)
#endif
#endif
#endif
