...
{
class MasterUDP : public MasterIOBase
{
public:
    MasterUDP(const MasterCommonData& data);
    ~MasterUDP();
    void connect(const Address<AddressType::UDP>& address, const std::chrono::milliseconds& connectTimeout);
